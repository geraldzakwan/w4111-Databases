...
def test_find_by_template(appearances_rdb):
    ...
    # assert len(appearances_rdb.find_by_template(None)) == 105789
    # assert len(appearances_rdb.find_by_template({})) == 105789
...
def test_insert(appearances_rdb):
    ...
    with pytest.raises(Exception):
        appearances_rdb.insert({'yearID': '2015', 'teamID': 'ATL', 'lgID': 'NL', 'playerID': 'aardsda01', 'G_all': '33', 'GS': '0', 'G_batting': '30', 'G_defense': '33', 'G_p': '33', 'G_c': '0', 'G_1b': '0', 'G_2b': '0', 'G_3b': '0', 'G_ss': '0', 'G_lf': '0', 'G_cf': '0', 'G_rf': '0', 'G_of': '0', 'G_dh': '0', 'G_ph': '0', 'G_pr': '0'})
...
def test_update_by_key(appearances_rdb):
    ...
    # assert appearances_rdb.find_by_template({'G_s': '150', 'G_all': '150'}) == 1
    # label = {'playerID': 'aardsda01', 'G_all': '33', 'GS': '0', 'G_batting': '30', 'G_defense': '33'}
    # assert appearances_rdb.find_by_primary_key(['aardsda01', 'ATL', '2015'],
    #                                            ['playerID', 'G_all', 'GS', 'G_batting', 'G_defense']) == label

    # # Example when a row matches the set of primary keys but no field_list is provided
    # # All the fields are returned in this case, this mimics the database behavior of SELECT *
    # label = {'GS': '0', 'G_1b': '0', 'G_2b': '0', 'G_3b': '0', 'G_all': '33', 'G_batting': '30', 'G_c': '0',
    #          'G_cf': '0', 'G_defense': '33', 'G_dh': '0', 'G_lf': '0', 'G_of': '0', 'G_p': '33', 'G_ph': '0',
    #          'G_pr': '0', 'G_rf': '0', 'G_ss': '0', 'lgID': 'NL', 'playerID': 'aardsda01', 'teamID': 'ATL',
    #          'yearID': '2015'}
    # assert appearances_rdb.find_by_primary_key(['aardsda01', 'ATL', '2015'], None) == label
    # assert appearances_rdb.find_by_primary_key(['aardsda01', 'ATL', '2015'], []) == label
    #
    # # No rows match the template, returning None
    # assert appearances_rdb.find_by_primary_key(['aardsda01', 'ATM', '2015'],
    #                                            ['playerID', 'G_all', 'GS', 'G_batting', 'G_defense']) == None
    #
    # # Example when insert fails because of conflicting primary keys
    # with pytest.raises(Exception):
