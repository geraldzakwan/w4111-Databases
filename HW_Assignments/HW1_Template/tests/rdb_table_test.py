...
def test_find_by_template(appearances_rdb):
    ...
    assert Helper.compare_two_list_of_dicts(appearances_rdb.find_by_template({"G_all": "150", "GS": "140", "G_ph": "7"}, ["playerID", "teamID", "yearID"]), label)
    ...
    assert Helper.compare_two_list_of_dicts(appearances_rdb.find_by_template({"G_all": "150", "GS": "140", "G_ph": "7"}), label)
...
def test_delete_by_key(appearances_csv, appearances_rdb):
...
def test_close_connection(appearances_rdb):
