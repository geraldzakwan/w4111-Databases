...
def test_find_by_template(appearances_csv):
    ...
    # assert len(appearances_csv.find_by_template(None)) == 105789
    # assert len(appearances_csv.find_by_template({})) == 105789
    ...
    assert Helper.compare_two_list_of_dicts(appearances_csv.find_by_template({'G_all': '150', 'GS': '140', 'G_ph': '7'}, ['playerID', 'teamID', 'yearID']), label)
    ...
    assert Helper.compare_two_list_of_dicts(appearances_csv.find_by_template({'G_all': '150', 'GS': '140', 'G_ph': '7'}), label)
...
def test_update_by_key(appearances_csv):
    ...
    appearances_csv.update_by_key(['aardsda01', 'ATL', '2015'], {}) == 0
    ...
    # assert appearances_csv.find_by_template({'G_s': '150', 'G_all': '150'}) == 1
    # label = {'playerID': 'aardsda01', 'G_all': '33', 'GS': '0', 'G_batting': '30', 'G_defense': '33'}
    ...
    #
    # # No rows match the template, returning None
    # assert appearances_csv.find_by_primary_key(['aardsda01', 'ATM', '2015'],
